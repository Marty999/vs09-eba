...
<div id="wrap">
	<div id="main">
		...
		<div id="header">
			<div class="content">
				<div class="top">
					<a href="#"><h1><img src="<?php echo Yii::app()->request->baseUrl.'/images/logo.png';?>" /><span><?php echo CHtml::encode(Yii::app()->name); ?></span></h1></a>
                                      <?php
                                        $userband = false;
                                        $userband_id = false;
                                        if(Yii::app()->user->band){
                                                $userband = Yii::app()->user->band->name; 
                                                $userband_id =Yii::app()->user->band->id;
                                        }
                                        $this->widget('zii.widgets.CMenu',array(
                                        'items'=>array(
                                          array('label'=>'Home', 'url'=>array('band/index')),
